from sensorservice.illuminanceservice.illuminanceservice import IlluminanceService
import boto3
import json
import time
import requests
...
class IllumDummySensor(IlluminanceService):
    def __init__(self):
        super().__init__()
        self.deviceid = "IllumSensor"
        self.place = "208"
