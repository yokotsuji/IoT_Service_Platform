from sensorservice.humidityservice.humidityservice import HumidityService
import os
import boto3
import datetime
...
class OpenWeatherHumid(HumidityService):
    def __init__(self):
        super().__init__()
    ...
    def get_data_from_api(self):
        ...
        print(f"Received Humidity data: {item}")
        table.put_item(Item=item)
        print(f"Saved humidity data: {item}")