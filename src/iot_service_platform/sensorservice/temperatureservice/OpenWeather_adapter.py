from sensorservice.temperatureservice.temperatureservice import TemperatureService
import os
import boto3
import datetime
...
class OpenWeatherTemp(TemperatureService):
    def __init__(self):
    ...
    def get_data(self):
        ...
        return data
        # if num == 1:
        #     data = self.construct_data(items[0], self.deviceid)
        #     return data

        # else:
        #     data_list = []
        #     for item in items:
        #         data = self.construct_data(item, self.deviceid)
